...
- **迷因（Meme）**：文化信息的基本单位，像基因一样复制、变异、竞争。迷因的演化不服务于人类利益—— viral 的谣言、危险的邪教都可以从迷因逻辑解释。
- **进化稳定策略（ESS）**：在特定条件下，合作可以在"自私的"基因驱动下稳定存在——关键是重复互动、可识别个体、惩罚背叛机制。
...
- [[concepts/Kin-Selection]] — 亲缘选择：通过帮助亲属间接复制基因
- [[concepts/Hamiltons-Rule]] — 汉密尔顿法则：rB > C 的利他演化条件
- [[concepts/Meme]] — 迷因：文化信息的复制单位
- [[concepts/Evolutionarily-Stable-Strategy]] — 进化稳定策略：无法被入侵的行为模式
- [[concepts/Tit-for-Tat]] — 以牙还牙：重复博弈中的最优合作策略
- [[concepts/Extended-Phenotype]] — 延伸的表型：基因影响超越个体边界
