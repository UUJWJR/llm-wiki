...
2. **传统自学的三座大山**：信息过载（3000+本书）、知行分离（懂但不会做）、缺乏反馈（错误3年后才被市场惩罚）。Agent集群把反馈周期从3年缩短到3分钟。

3. **四级进阶路径**：
   - Level 1 筑基期（1-3周）：复利、能力圈、市场先生、安全边际
   - Level 2 财报语言（4-6周）：三大报表、ROE拆解、护城河
   - Level 3 估值艺术（7-9周）：DCF、安全边际、三种情景
   - Level 4 组合与心性（10-12周）：组合管理、凯利公式、投资纪律手册

4. **四大核心原则**：不懂不投（能力圈）、安全边际（30%+容错）、长期主义（3-5年持有逻辑）、第一性原理（追溯商业本质）。
